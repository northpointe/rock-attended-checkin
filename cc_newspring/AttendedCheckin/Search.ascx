    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlSearch" runat="server" DefaultButton="lbSearch" CssClass="attended">
            ...
            <div class="row checkin-header">
                ...
                <div class="col-xs-8">
                    <Rock:RockTextBox ID="tbSearchBox" MaxLength="50" CssClass="checkin-phone-entry" runat="server" Placeholder="Enter First Name, Last Name or Phone" Label="" TabIndex="0" />
